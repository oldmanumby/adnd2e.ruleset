...
![](_assets/Simpathetic.jpg)

| Statistic | **Simpathetic** |
| --- | --- |
| **Activity Cycle:** | Day |
...
Originally from the Seventh Hell, this "bird" now makes its home in a number of grassy plains throughout the Prime Material Plane. Although everything about it indicates that it is a [[Bird|bird]], there are some very unusual aspects of the creature that indicate something more sinister and alien.
